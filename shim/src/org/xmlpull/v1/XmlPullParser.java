...
/**
 * The XmlPull v1 parser API (public domain, xmlpull.org), which Android ships on
 * its boot classpath and the JDK does not. Constants match the published values
 * because api-impl and the app have them inlined.
 */
