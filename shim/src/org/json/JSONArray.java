...
/** A modifiable sequence of JSON values. */
public class JSONArray {
	...
	public JSONArray(Collection<?> copyFrom) {
		...
		for (Object value : copyFrom)
			values.add(JSONObject.wrap(value));
	}
	...
	public JSONArray(Object array) throws JSONException {
		...
		for (int i = 0; i < length; i++)
			values.add(JSONObject.wrap(Array.get(array, i)));
	}
	...
	/** Grows the array with nulls when the index is past the end, as org.json does. */
	...
	public String join(String separator) throws JSONException {
		...
		for (int i = 0, size = values.size(); i < size; i++) {
			...
			joined.append(JSONStringer.encode(values.get(i)));
		}
